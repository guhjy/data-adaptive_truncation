# Demonstration of an asymptotically rate-optimal method to choose the truncation level
# For a candidate rate, it relies on checking whether a certain statistic 
# is increasing or decreasing as a function of sample size. Increasing implies the candidate rate is too slow,
# decreasing that it is too fast.
# The statistic is computed on a set of nested subsamples. The nested subsamples are represented
# by a tree structure, the subsampling tree.
source('TMLE_scripts/utilities.R')
source('TMLE_scripts/true_target_parameters_derivatives_and_ICs.R')
source('TMLE_scripts/generate_data.R')
source('TMLE_scripts/TMLE_extrapolation_functions.R')
